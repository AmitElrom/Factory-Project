...
async function loadAddDepartment()
{
    // get all employees except from department managers
...
{
    let depName = document.querySelector("#department_name").value;
    ...
    let resp = await fetch("https://localhost:44364/api/department", fetchParams)
